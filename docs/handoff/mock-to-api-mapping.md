...
| `updatePlatformSharing(viewer, assistantId, accountIds)` `:268-272` | `PUT /api/v1/assistants/{id}/publishing/platform` | `S+OWN` | `200` `PlatformSharingView` | `422` `PublishingFieldError[]`／`409`／`429` | `401`／`403 publishing`／`5xx` | `features/publishing/platform-sharing/platform-sharing.component.ts:40` |
