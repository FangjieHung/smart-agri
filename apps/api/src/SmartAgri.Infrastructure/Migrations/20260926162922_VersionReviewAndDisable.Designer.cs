...
namespace SmartAgri.Infrastructure.Migrations
{
    ...
    [Migration("20260926162922_VersionReviewAndDisable")]
    partial class VersionReviewAndDisable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartAgri.Domain.Ai.ModelInvocation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartAgri.Domain.Knowledge.KnowledgeDocument", b =>
                {
                    ...
                    b.HasIndex("DisabledByAccountId", "OrganizationId");
                    ...
                    b.ToTable("KnowledgeDocuments", null, t =>
                        {
                            t.HasCheckConstraint("CK_KnowledgeDocuments_Disabled", "(\"DisabledAt\" IS NULL AND \"DisabledByAccountId\" IS NULL AND \"DisabledReason\" IS NULL) OR (\"DisabledAt\" IS NOT NULL AND \"DisabledByAccountId\" IS NOT NULL AND \"DisabledReason\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("SmartAgri.Domain.Knowledge.KnowledgeDocumentVersion", b =>
                {
                    ...
                    b.HasIndex("ApprovedByAccountId", "OrganizationId");
                    ...
                    b.HasIndex("DocumentId", "EffectiveFrom", "VersionNumber")
                        .HasFilter("\"ReviewState\" = 'approved'");

                    b.HasIndex("DocumentId", "KnowledgeBaseId", "OrganizationId");

                    b.ToTable("KnowledgeDocumentVersions", null, t =>
                        {
                            t.HasCheckConstraint("CK_KnowledgeDocumentVersions_Review", "(\"ReviewState\" = 'pending-review' AND \"EffectiveFrom\" IS NULL AND \"ApprovedByAccountId\" IS NULL AND \"ApprovedAt\" IS NULL) OR (\"ReviewState\" = 'approved' AND \"EffectiveFrom\" IS NOT NULL AND \"ApprovedByAccountId\" IS NOT NULL AND \"ApprovedAt\" IS NOT NULL AND \"EffectiveFrom\" >= \"ApprovedAt\" AND \"ProcessingStatus\" IN ('ready', 'partially-readable'))");
                        });
                });
            ...
            modelBuilder.Entity("SmartAgri.Domain.Knowledge.KnowledgeChunk", b =>
                {
                    ...
                    b.HasOne("SmartAgri.Domain.Knowledge.KnowledgeDocumentVersion", "Version")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartAgri.Domain.Knowledge.KnowledgeDocument", b =>
                {
                    ...
                    b.HasOne("SmartAgri.Infrastructure.Accounts.Account", null)
                        .WithMany()
                        .HasForeignKey("DisabledByAccountId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("SmartAgri.Domain.Knowledge.KnowledgeDocumentVersion", b =>
                {
                    ...
                    b.HasOne("SmartAgri.Infrastructure.Accounts.Account", null)
                        .WithMany()
                        .HasForeignKey("ApprovedByAccountId", "OrganizationId")
                        .HasPrincipalKey("Id", "OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("SmartAgri.Domain.Knowledge.KnowledgeDocument", "Document")
                        .WithMany("Versions")
