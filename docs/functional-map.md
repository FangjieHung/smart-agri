...
| 我的助理 | `/app/assistants` | 查看我建立的助理和所有草稿、使用組織分享的助理 | 已選 Demo 身分；內容依權限過濾 |
...
| 對話 | `/app/chat/:assistantId/:conversationId?` | 對話、完整歷史、改名、刪除 | 本人擁有或獲組織分享 |
...
3. 組織建立的助理來自 `listUsableAssistants()` 的權限結果。助理擁有者仍可管理自己的助理。
